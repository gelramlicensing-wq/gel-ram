...
- `write_atomic` writes a sibling `<name>.tmp-<pid>-<n>` file created with O_EXCL semantics and renames it into place. `write_if_newer` assumes a single writer and is not a compare-and-swap.
